...
// 32b / 9b div
uint32_t BIN_OP_DIV_uint32_t_uint9_t(uint32_t left, uint9_t right)
{
  // Resize
  ...
  */
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_31(output, 1);
  }
  // Bit 30
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_30(output, 1);
  }
  // Bit 29
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_29(output, 1);
  }
  // Bit 28
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_28(output, 1);
  }
  // Bit 27
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_27(output, 1);
  }
  // Bit 26
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_26(output, 1);
  }
  // Bit 25
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_25(output, 1);
  }
  // Bit 24
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_24(output, 1);
  }
  // Bit 23
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_23(output, 1);
  }
  // Bit 22
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_22(output, 1);
  }
  // Bit 21
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_21(output, 1);
  }
  // Bit 20
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_20(output, 1);
  }
  // Bit 19
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_19(output, 1);
  }
  // Bit 18
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_18(output, 1);
  }
  // Bit 17
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_17(output, 1);
  }
  // Bit 16
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_16(output, 1);
  }
  // Bit 15
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_15(output, 1);
  }
  // Bit 14
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_14(output, 1);
  }
  // Bit 13
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_13(output, 1);
  }
  // Bit 12
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_12(output, 1);
  }
  // Bit 11
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_11(output, 1);
  }
  // Bit 10
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_10(output, 1);
  }
  // Bit 9
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_9(output, 1);
  }
  // Bit 8
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_8(output, 1);
  }
  // Bit 7
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_7(output, 1);
  }
  // Bit 6
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_6(output, 1);
  }
  // Bit 5
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_5(output, 1);
  }
  // Bit 4
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_4(output, 1);
  }
  // Bit 3
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_3(output, 1);
  }
  // Bit 2
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_2(output, 1);
  }
  // Bit 1
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_1(output, 1);
  }
  // Bit 0
  ...
  if(remainder >= right)
  {
    remainder = remainder - right;
    // Set output(i)=1
    output = uint32_uint1_0(output, 1);
  }
  return output;
}